 ...
 * Size: 14 px
 * Bpp: 4
 * Opts: --bpp 4 --size 14 --font D:/Workspace/Freelancer/esp32s3-air-mon/SquarelineStudioProject/assets/Fonts/OpenSans-Regular.ttf -o D:/Workspace/Freelancer/esp32s3-air-mon/SquarelineStudioProject/assets/Fonts\ui_font_OpenSans_Regular_14.c --format lvgl -r 0x20-0x7f --symbols ₀₁₂.₅ --no-compress --no-prefilter
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3107, .adv_w = 78, .box_w = 5, .box_h = 6, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3122, .adv_w = 78, .box_w = 4, .box_h = 6, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3134, .adv_w = 78, .box_w = 5, .box_h = 6, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 3149, .adv_w = 78, .box_w = 5, .box_h = 6, .ofs_x = 0, .ofs_y = -2}
};
